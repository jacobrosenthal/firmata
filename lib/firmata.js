...
/**
 * Configure arduino to sleep
 * @param {number} delay in seconds
 * @param {number} mode 0 default regular, 1 deep
 */

Board.prototype.sendSleepConfig = function(delay, mode) {
  delay = delay || 0;
  this.sp.write(new Buffer([START_SYSEX, SLEEP_CONFIG, (delay & 0xFF), ((delay >> 8) & 0xFF), (mode & 0xFF), END_SYSEX]));
};
